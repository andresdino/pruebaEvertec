...
<?php $__env->startSection('content_header'); ?>
    <h1 class="m-0 text-dark"><i class="icon fas fa-home"></i> Shopping</h1>
                    ...
                    <form action="<?php echo e(route('orders.store')); ?>" method="post">
                        ...
                        <div class="card">
                            <div class="card-header bg-gradient-success">
                                <h3 class="card-title"><i class="fa fa-fw fa-file-contract"></i> Realizar pedido</h3>
                            </div>
                            <div class="card-body">
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\hecto\OneDrive\Escritorio\evertec\resources\views/home.blade.php ENDPATH**/ ?>