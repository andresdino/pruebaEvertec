                ...
                <div class="card-body">
                    <div class="card">
                        <div class="card-header bg-gradient-primary">
                            <h3 class="card-title"><i class="icon fas fa-clone"></i> Pedidos</h3>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-sm-12">
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\hecto\OneDrive\Escritorio\evertec\resources\views/web/orders/list.blade.php ENDPATH**/ ?>