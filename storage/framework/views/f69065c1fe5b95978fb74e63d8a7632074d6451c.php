                ...
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link" data-widget="pushmenu" href="#" <?php if(config('adminlte.sidebar_collapse_remember')): ?> data-enable-remember="true" <?php endif; ?> <?php if(!config('adminlte.sidebar_collapse_remember_no_transition')): ?> data-no-transition-after-reload="false" <?php endif; ?> <?php if(config('adminlte.sidebar_collapse_auto_size')): ?> data-auto-collapse-size="<?php echo e(config('adminlte.sidebar_collapse_auto_size')); ?>" <?php endif; ?>>
                            ...
                            <span class="sr-only"><?php echo e(__('adminlte.toggle_navigation')); ?></span>
                        </a>
                    </li>
                    <?php echo $__env->renderEach('adminlte::partials.menu-item-top-nav', $adminlte->menu(), 'item'); ?>
                    ...
                    <?php if(auth()->guard()->check()): ?>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                                <span class="dropdown-item dropdown-header"><?php echo e(isset($notifications)?$notifications->count():0); ?> Notificaciones</span>
                                ...
                                <?php if(isset($notifications)): ?>
                                    <?php $__currentLoopData = $notifications->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <a href="<?php echo e(route('notification.unread', ['id' => $notification->id])); ?>" class="dropdown-item text-xs">
                                            <i class="fas fa-<?php echo e($notification->data['icon']); ?> mr-2"></i> <?php echo e($notification->data['message_left']); ?>

                                            <span class="float-right text-muted"><?php echo e($notification->data['message_right']); ?></span>
                                        </a>
                                        <div class="dropdown-divider"></div>
                        ...
                        <li class="nav-item">
                            ...
                            >
                                <i class="fa fa-fw fa-power-off"></i> <?php echo e(__('adminlte.log_out')); ?>
                    ...
                    <?php if(auth()->guard()->guest()): ?>
                        <li class="nav-item dropdown">
                            <a class="nav-link" href="<?php echo e(route('login')); ?>">
                                <i class="fa fa-fw fa-sign-in-alt"></i> <?php echo e(__('adminlte.sign_in')); ?>

                            </a>                            
                        </li>                        
                        <li class="nav-item dropdown">
                            <a class="nav-link" href="<?php echo e(route('register')); ?>">
                                <i class="fa fa-fw fa-user-plus"></i> <?php echo e(__('adminlte.register')); ?>
...
<?php echo $__env->make('adminlte::master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\hecto\OneDrive\Escritorio\evertec\resources\views/vendor/adminlte/page.blade.php ENDPATH**/ ?>